...
import com.example.soa_guildwars2.domain.datamodel.WalletDataModel
...
import com.example.soa_guildwars2.domain.usecases.GetAllWorldBoss
import com.example.soa_guildwars2.domain.usecases.GetApiKey
import com.example.soa_guildwars2.domain.usecases.GetPvEDailyAchievements
import com.example.soa_guildwars2.domain.usecases.GetWalletData
import com.example.soa_guildwars2.domain.usecases.RemoveApiKey
        ...
        getWalletData.execute()
            ...
            .subscribe(object : DisposableObserver<List<WalletDataModel>>() {
                override fun onNext(walletDataModel: List<WalletDataModel>) {
                    ...
                    when {
                        totalGold.toInt() >= 10000 -> _silver.postValue(
                            totalGold.takeLast(4).take(2).toInt()
                        )
